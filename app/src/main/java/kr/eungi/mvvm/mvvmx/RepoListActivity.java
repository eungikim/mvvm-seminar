...
public class RepoListActivity extends AppCompatActivity implements RepositoryAdapter.OnRepositoryItemClickListener {
    ...
    private void setupObserver(RepoListViewModel viewModel) {
        viewModel.getSnackbarEvent().observe(this, this::showSnackbar);
        viewModel.getProgressEvent().observe(this, this::showProgressBar);
        viewModel.getRepositoriesData().observe(this,
                repositoryItems -> repositoryAdapter.setItemsAndRefresh(repositoryItems)
        );
    }
